...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdeliver.net/npm/bootstrap-icons@1.11.0/font/bootstrap-icons.css">
</head>
<body>
    <?php
    // ===== DATA PERPUSTAKAAN =====
    $nama_perpus = "Perpustakaan Digital IPB University";
    $alamat = "Jl. Jalan No. 331, Bogor";
    $telepon = "(021) 1234-5678";
    $email = "info@perpusipb.ac.id";
    ...
    $persen_tersedia = ($buku_tersedia / $total_buku) *100;
    ...
    //  ====== TRANSAKSI HARI INI ======
    $transaksi_hari_ini = 21;
    $peminjaman = 12;
    $pengembalian = 7;

    // ====== BUKU TERPOPULER ======
    $buku1 = "Pemprograman Web PHP";
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="colllapse" data-bs-target="#navbarnav">
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                ...
                <p class="text-muted">
                    <i class="bi bi-calender"></i> <?php echo $hari_ini; ?> |
                ...
                <div class="card boorder-succes">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-succes" style="font-size: 48px;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <span><i class="bi bi-arrow-left-right text-succes"></i> Pengembalian</span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="badge bg-succes"><?php echo $pinjam2; ?>x</span>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <p class="mb-2">
                            <i class="bi bi-telephone text-succes"></i>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="progress" style="height: 30px;">
                                    <div class="progress-bar bg-succes" role="progressbar"
                                        style="width: <?php echo $persen_tersedia; ?>%;"
                                        aria-valuenow="<?php echo $persen_tersedia; ?>%;"
                                        aria-valuemin="0" aria-valuemax="100">
                                        <?php echo number_format($persen_tersedia, 1); ?>%
...
<!-- #region -->                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <h6>Buku Dipinjam</h6>
                                <div class="progress" style="height: 30px;">
                                    <div class="progress-bar bg-warning" role="progress-bar"
