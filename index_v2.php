...
<body>
    <div class="card"
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "M. Risqi Agung Pratama"; ?></p>
            <p><strong>Tangga:</strong> <?php echo date('d F Y'); ?></p>
        ...
        $nama_perpus    = "Perpustakaan Institut Pertanian Bogor";
        $total_buku     = 1250;
        $total_anggota  = 500;
        $buku_dipinjam  = 180;
        ...
        // Intruksi 2, 3, & 5: Deklarasi Variabel Baru
        $alamat_perpus      = "Jl. Pahlawan, Rowolaku, Kajen, Kab. Pekalongan";
        $telepon_perpus     = "(0285) 123456";
        $jam_buka           = "08:00 WIB";
        $jam_tutup          = "16:00 WIB";
        $persen_tersedia    = round(($buku_tersedia / $total_buku) * 100, 1);
        ?>

        <div class="perpus-info">
            ...
            <p><strong>Jam Operasional:</strong> <?php echo $jam_buka . " - " . $jam_tutup; ?></p>
